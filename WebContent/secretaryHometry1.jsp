...
<ul class="navbar-nav mr-auto">
  ...
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#addResident"><i class="fa fa-plus"></i> Add resident details</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#getvinfo"><i class="far fa-user"></i> Display all residents</a>
  </li>
  <li class="nav-item">
	...
	<div class="card-header"><legend><i class="fas fa-user-edit"></i> Fill resident details </legend></div>
  	...
  	<fieldset>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="password" class="form-control" id="password" name = "password" placeholder="Password" required pattern="(?=.*\d)(?=.*[a-z]).{6,}" title="Password must contain at least 6 characters, including UPPER/lowercase and numbers.">
        </div>
        </div>
        <div class="form-group row">
...
<div class="container">
	...
	<div class="card-header"><legend><i class="fas fa-users"></i> All residents </legend></div>
  	<div class="card-body">
...
<div class="tab-pane active" id="getrinfo">
  <div class="bs-docs-section">
  <div class="row">
  <div class="col-lg-3">
...
System.out.println("checking flatNo:" + flatNo1 + ",");
Resident resident = (Resident)session.getAttribute("resident");
if(flatNo1 != ""  && flatNo1 != null && resident != null){
%>
...
final String QUERY = "select * from Residents where flatNo="+flatNo1+"";
